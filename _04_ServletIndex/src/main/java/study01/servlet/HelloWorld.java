...
public class HelloWorld implements Servlet {
	...
	public String getServletInfo() {
		...
		return "ver=1.0;author=albert;copyright=albert;";
	}

	
	/* 톰캣은 서블릿 객체와 연결된 주소로 요청이 들어오면
	 * 그때 해당 객체를 생성한다.
	 * 객체 생성시 호출되는 메서드는 init()이다.
	 * 그리고 해당 요청을 처리하기위해 service()로 요청이 톰캣으로부터 전달된다.
	 * */
	@Override
	...
	/* 한번 객체가 만들어지고 나서 이후의 요청은 init()은 호출되지 않고
	 * service()만 호출된다.
	 */
	@Override
