 ...
 * 필요가 없다.
 * Servlet만들면 기능동작에는 문제가 없지만, 향후 다른 Framework에 이식할때
 * 수정할 부분이 많아지므로, Servlet에 종속적이기보다, 일반 java클래스로 만드는 것이
 * 나은 선택이다.
 * 이러한 방식으로 Pojo라고 하고,
 ...
 * 모든 PageController는 아래 Controller인터페이스를 상속받는다.
 * 
 */
