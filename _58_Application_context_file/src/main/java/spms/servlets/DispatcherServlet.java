...
public class DispatcherServlet extends HttpServlet{
	...
	private void prepareRequestData(HttpServletRequest req, Map<String, Object> model, DataBinding dataBinding) throws Exception{
...
//			Controller pageController = (Controller)this.getServletContext().getAttribute(servletPath);
			...
			if(pageController == null) {
				throw new Exception("요청한 Controller객체를 찾을 수 없어서, 서비스 제공 불가");
			}
			
			// DataBinding인터페이스를 상속받은 pageController인 경우
